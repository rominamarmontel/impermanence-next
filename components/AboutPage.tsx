      ...
      <div>
        <div className="md:w-[50%]">
          ...
          <p className={styles.AboutText}>
            ...
            les films produits dans un contexte de liberté formelle. En soutien
            aux oeuvres indépendantes, Impermanence Films mutualise et met à
        ...
        <div className="w-full flex gap-10 flex-wrap justify-between">
          <p className={`md:w-[45%] ${styles.AboutText}`}>
            ...
            le plein contrôle éditorial, et son soutien à la distribution aide
            la visibilité du film grâce au réseau et aux plateformes
            d’Impermanence. Les oeuvres accompagnées par Impermanence Films,
            tant à la production qu’à la distribution, ont été diffusées et
            primées dans les festivals internationaux, diffusées en salle et à
            la télévision. En 2022-2023, les activités de production ont pris de
            l’essor et la distribution continue. Dans chaque domaine, le soutien
            proposé s’adapte aux besoins de chaque film. À l’origine du projet
            Impermanence, Les Rencontres Siréales ont réuni annuellement entre
            2005 et 2008, des plasticiennes et réalisatrices autour des
            créations collectives et de la diffusion de leur travail, avec un
          ...
          <p className={`md:w-[45%] ${styles.AboutText}`}>
            ...
            auteur.rices-réalisateur.rices gravitant autour d’Impermanence
            Films. Des projets collaboratifs autour d’artistes sont actuellement
            en production et une reprise des Rencontres Siréales est prévue pour
            2024.
          </p>
        </div>
      </div>
